...
export const SoR = [
    {
        ...archetype('SoR', 19,'Adeptus Astartes','Blood Claw',3,'Adeptus Astartes'),
        ...costz(24,[
        ...
        hint: 'An eager young warrior, ready to prove himself.',
        keywords: 'Imperium,Adeptus Astartes,Primaris,Space Wolves',
        archetypeFeatures: [
            {
                name: 'Fury of the Pack',
                snippet:
                    'Once per combat, when you charge or make your first Melee Attack in a scene: ' +
                    'Allies within 10m who can hear you gain +1 Rank to their next melee attack test this round, OR' +
                    'You can use this movement to interpose yourself between an attack and its target, making you the target',
            },
        ],
        wargear: wargearz('Mark X Tacticus Power Armour, Astartes Chainsword, Astartes Combat Knife, Bolt Pistol, 3 Frag Grenades, 3 Krak Grenades'),
        influence: 2,
    },
    {
